  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="w-full max-w-sm space-y-6 text-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">DailyPod</h1>
          <p className="mt-2 text-gray-600">
            Your personalized daily audio briefing
          </p>
        </div>
        ...
        <p className="text-xs text-gray-500">
          Sign in to create your personalized daily briefing podcast.
        </p>
      </div>
    </div>
  );
